...
const Header = () => {
  ...
  return (
    ...
    <header className="fixed z-50 w-screen bg-white text-black px-1 md:px-7 shadow-md select-none ">
      {/**desktop & tablet */}
      <div className="hidden px-20 md:flex w-full justify-between">
        ...
        <div className="flex items-center gap-8">
          ...
          >
            ...
            <NavLink to={"/myorders"} onClick={()=>window.scrollTo({top: 0, behavior: 'smooth'})}  className={({isActive}) =>`text-base text-textColor hover:text-headingColor duration-100 transition-all ease-in-out cursor-pointer  box-border h-full flex items-center hover:border-b-4 hover:border-red-600 hover:font-semibold p-1 ${isActive ? "border-b-4 border-red-600 font-semibold" : ""} `}>
              My orders
            </NavLink>
          ...
          {isLogin && (
            ...
            <div className="arrowShow"></div>
              <div className="w-full ">
                <ul className="flex flex-col  h-full px-20 ">
                  ...
                  <NavLink to={"/myorders"} onClick={()=>setIsLogin(false)} className="text-base  whitespace-nowrap flex hover:bg-red-50 hover:text-slate-600 py-2 rounded hover:font-semibold px-3 items-center w-full gap-3 ">
                    My Orders
                  </NavLink>
                </ul>
              </div>
